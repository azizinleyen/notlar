...
**Download for Windows:** [Installer (.exe)](https://github.com/azizinleyen/notlar/releases/download/v0.1.1/Notlar-Setup-0.1.1-x64.exe) | [Portable (.exe)](https://github.com/azizinleyen/notlar/releases/download/v0.1.1/Notlar-portable-0.1.1-x64.exe) | [Release notes](https://github.com/azizinleyen/notlar/releases/tag/v0.1.1)
...
Download and run the [Windows installer](https://github.com/azizinleyen/notlar/releases/download/v0.1.1/Notlar-Setup-0.1.1-x64.exe). For use without installation, download the [portable build](https://github.com/azizinleyen/notlar/releases/download/v0.1.1/Notlar-portable-0.1.1-x64.exe). Both files are attached to the [v0.1.1 release](https://github.com/azizinleyen/notlar/releases/tag/v0.1.1); installer binaries are kept out of the source repository.
